    ...
    <>
      ...
      <SuccessContainer>
        ...
        <p>
          ...
          {productTotalCount}{' '}
          {productTotalCount === 1 ? 'camiseta' : 'camisetas'} já está a caminho
          da sua casa.{' '}
        </p>
...
export const getServerSideProps: GetServerSideProps = async ({ query }) => {
  ...
  const session = await createStripe(true).checkout.sessions.retrieve(
    sessionId,
    {
  ...
  const productTotalCount = session.line_items.data.reduce((prev, item) => {
